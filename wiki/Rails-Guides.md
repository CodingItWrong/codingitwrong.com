...
- [Views](http://guides.rubyonrails.org/action_view_overview.html)

## Secondary

- [Active Support](http://guides.rubyonrails.org/active_support_core_extensions.html)
- [Active Model](http://guides.rubyonrails.org/active_model_basics.html)
- [Asset Pipeline](http://guides.rubyonrails.org/asset_pipeline.html)
- [Autoloading](http://guides.rubyonrails.org/autoloading_and_reloading_constants.html)
...
- [JavaScript](http://guides.rubyonrails.org/working_with_javascript_in_rails.html)
- [Jobs](http://guides.rubyonrails.org/active_job_basics.html)
- [Mailers](http://guides.rubyonrails.org/action_mailer_basics.html)
