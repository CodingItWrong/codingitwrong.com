...
(*Note:* if you have trouble with connections timing out while following the instructions below, and you're on macOS, you can download [a Squeak 5.3 image with Morphic Designer pre-installed](/downloads/squeak-5.3-with-morphic-designer.dmg).)
